 ...
 * 全局变量区
 */
int int_data[TEST_COUNT];
double double_data[TEST_COUNT];
char char_data[TEST_COUNT];
char string_data[TEST_COUNT][MAX_STRING_LEN];
TestData struct_data[TEST_COUNT];
